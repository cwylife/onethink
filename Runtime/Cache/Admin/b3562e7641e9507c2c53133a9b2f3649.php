...
<body>
	...
	<form action="<?php echo U();?>" method="post" class="form-horizontal">
		...
		<div class="form-item">
			<label class="item-label">保修电话<span class="check-tips"></span></label>
			<div class="controls">
		...
		<div class="form-item">
			...
			<div class="controls">
				...
				</label>				<!--<input type="content" class="text input-large" name="tel" value="<?php echo ((isset($info["tel"]) && ($info["tel"] !== ""))?($info["tel"]):''); ?>">-->
			</div>
		</div>
		<div class="form-item">
